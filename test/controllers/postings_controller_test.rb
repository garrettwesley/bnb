...
class PostingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create posting" do
    assert_difference('Posting.count') do
      post postings_url, params: { posting: { description: @posting.description, price: @posting.price, title: @posting.title } }
    end
  ...
  test "should update posting" do
    patch posting_url(@posting), params: { posting: { description: @posting.description, price: @posting.price, title: @posting.title } }
